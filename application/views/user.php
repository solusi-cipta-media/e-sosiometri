    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="alert alert-primary" role="alert">
                <strong>Info :</strong> Halaman ini digunakan untuk menambahkan dan menghapus user!
            </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalgrid">
                                <i class="las la-plus-circle"></i> Tambah User
                            </button>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    $(function() {
        $("#table-user").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>dashboard/ajax_table_karyawan',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
    ...
    $("#form-data").submit(function(e) {
        ...
        if ($('#name').val() == '' || $('#userid').val() == '' || $('#role_id').val() == '' || $('#password').val() == '') {
            Swal.fire(
                'error!',
