            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Laporan Analisis</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Laporan Analisis</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Laporan Analisis</h5>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    $(function() {
        $("#table-kuesioner").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>laporan/ajax_analisis',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
                ...
                "target": [<?= $target ?>],
                "className": 'text-center py-1',
                "data": "data.status_kuesioner",
            }, {
                "target": [<?= $target ?>],
                "className": 'text-center py-1',
                "data": "data",
                "render": function(data) {
                    return `<button type="button" class="btn btn-sm btn-success" onclick=individu('${data.id}')><i class="ri-user-line"></i> Individu</button>
                     <button type="button" class="btn btn-sm btn-info" onclick=kelompok('${data.batch}')><i class="ri-group-line"></i> Kelompok</button>`
                }
            }, ],
    ...
    function individu(id) {
        window.open(`${base_url}laporan/individu/${id}`, '_blank');
    }

    function kelompok(id) {
        window.open(`${base_url}laporan/kelompok/${id}`, '_blank');
    }
</script>