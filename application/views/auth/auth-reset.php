...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Sistem Informasi Sosiometri - E-Sosiometri</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="alert alert-borderless alert-warning text-center mb-2 mx-2" role="alert">
                                    Masukan email, link reset akan segera dikirimkan!
                                </div>
                                <div class="p-2">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Saya ingat password saya... <a href="<?= base_url('auth') ?>" class="fw-semibold text-primary text-decoration-underline"> Login </a> </p>
                        </div>
    ...
    <!-- particles js -->
    <script src="<?= base_url('assets/default/') ?>assets/libs/particles.js/particles.js"></script>

    <!-- particles app js -->
    <script src="<?= base_url('assets/default/') ?>assets/js/pages/particles.app.js"></script>
</body>
