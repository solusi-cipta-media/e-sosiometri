                                    ...
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form action="<?= base_url('auth/signup') ?>" method="post">
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-12 text-muted fst-italic">Dengan mendaftarkan Anda menyetujui <a href="javascript:void(0)" class="text-primary text-decoration-underline fst-normal fw-medium">Syarat & Ketentuan</a></p>
                                                </div>
