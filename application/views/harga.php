    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="alert alert-primary" role="alert">
                <strong>Info :</strong> Halaman ini digunakan untuk menambahkan dan menghapus Pekerjaan!
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Harga Pekerjaan</h5>
                            ...
                            <table id="table-user" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-ordering="false">Harga</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                            </table>
                ...
                <form id="form-data">
                    <div class="row g-3">
                        <div class="col-xxl-12">
                            <div>
                                <label for="pekerjaan" class="form-label">Jenis Kendaraan</label>
                                <input type="text" class="form-control" id="pekerjaan" onkeyup="this.value = this.value.toUpperCase()">
                            </div>
                        </div><!--end col-->
                        <div class="col-xxl-12">
                            <div>
...
<script>
    ...
    $(function() {
        $("#table-user").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>dashboard/ajax_table_harga',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
    ...
    $("#form-data").submit(function(e) {
        ...
        form_data.append('table', 'harga');
        form_data.append('pekerjaan', $("#pekerjaan").val());
        form_data.append('harga', $("#harga").val());

        var url_ajax = '<?= base_url() ?>dashboard/insert_data_harga'
