    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="alert alert-primary" role="alert">
                <strong>Info :</strong> Halaman ini digunakan untuk mengunduh laporan dalam bentuk Excel!
            </div>
                        ...
                        <div class="card-body">
                            <form id="form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-4">
                                        <div>
                                            <!-- <a id="btn_download_excel" class="btn btn-alt-success mt-1"><i class="si si-cloud-download"></i> Download</a> -->
                                            <a class="btn btn-success" style="margin-top: 25px;" id="btn_download_excel"><i class="ri-file-excel-2-line "></i> Generate</a>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </form>
...
<script>
    ...
    //     $("#btn_download_excel").attr("href", "<?= base_url('dashboard/generatedata') ?>?tanggal_awal=" + awal + "&tanggal_akhir=" + akhir)
    // });
    ...
    $('#btn_download_excel').on('click', function() {
        ...
        // window.location.href = "<?= base_url('dashboard/generatedata') ?>?tanggal_awal=" + awal + "&tanggal_akhir=" + akhir ";
